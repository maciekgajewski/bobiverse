...
| [BOB-034](BOB-034-expressive-starfield-visual-hierarchy.md) | Blocked | Add expressive stars, subtle narrative hierarchy, and a whisper grid. |
...
| [BOB-036](BOB-036-chapter-inspector-and-compact-timeline.md) | Done | Make chapters inspectable and simplify Chapter-mode timeline labels. |
